...
for file_path in dirs:
    ...
    for symbol_match in symbols_match:
        symbol_dict = {}
        symbol_alias1 = str(symbol_match.group(1)).upper().replace("-","").replace(" ","")
        symbol_alias2 = str(symbol_match.group(2)).upper().replace("-","").replace(" ","")
        symbol_alias3 = str(symbol_match.group(3)).upper().replace("-","").replace(" ","")
        symbol_alias4 = str(symbol_match.group(4)).upper().replace("-","").replace(" ","")
